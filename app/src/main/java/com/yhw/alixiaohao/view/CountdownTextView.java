...
public class CountdownTextView extends TextView {
            ...
            switch (msg.what){
                case what_count_down_tick:
                    if(mSeconds <= 0){
                        ...
                        onResultCallBackInterface.callBack();
                    }else {
    ...
    public void setOnResultCallBackInterface(OnResultCallBackInterface onResultCallBackInterface) {
        this.onResultCallBackInterface = onResultCallBackInterface;
    }

    private OnResultCallBackInterface onResultCallBackInterface;

    public interface OnResultCallBackInterface{
        void callBack();
    }
